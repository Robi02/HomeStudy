...
public class QAlbum extends EntityPathBase<Album> {
    ...
    private static final long serialVersionUID = 1523114312L;
    ...
    //inherited
    public final ListPath<com.de4bi.study.jpa.jpashop.domain.Category, com.de4bi.study.jpa.jpashop.domain.QCategory> categories = _super.categories;
