...
public class SAQLv2_003 {
    
    public int solution(String arrangement) {
        final char[] arr = arrangement.toCharArray();
        int stkCnt = 0;
        int rtCnt = 0;
        char lastSym = '?';

        for (int i = 0; i < arr.length; ++i) {
            final char curSym = arr[i];

            if (curSym == '(') { // begining of stick or laser
                ++stkCnt;
            }
            else { // ')'
                --stkCnt;
    ...
    public static void main(String[] args) {
        // ================================================================
        final SAQLv2_003 solution = new SAQLv2_003();
        final String arrangement = "()(((()())(())()))(())"; // result: 17
        // ================================================================
        final long bgnTime = System.currentTimeMillis();
        final int result = solution.solution(arrangement);
